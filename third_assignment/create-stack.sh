...
openstack stack create -t server-landscape.yaml --wait --parameter external_net=tu-internal --parameter key_pair=$KEY_PAIR --parameter "flavor=Cloud Computing" --parameter image=ubuntu-16.04 --parameter "zone=Cloud Computing" $STACK